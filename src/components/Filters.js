...
<div className='form-control'>
  ...
  {colors.map((c, index)=>{
if(c==='all'){
  return <button key={index} name='color' onClick={updateFilters} style={{background: c}} data-color='all' className={`${color === 'all' ? 'all-btn active':'all-btn'}`}>all</button>
}
...
<div className='form-control'>
  ...
  onChange={updateFilters} min={min_price} 
